...
downloadButton("report", label = "Create PDF")
...
downloadHandler(
    filename = function() { paste(input$stock1, Sys.Date(),'report.html', sep='_') },
    content =  function(filename) {
                    rmarkdown::render("Portfolio flex/HTML_template/stock_report.Rmd",
...
downloadHandler(
    ...
    content =  function(filename) {
                    rmarkdown::render("HTML_PDF_shiny_rmd_templates/riskTolerance.Rmd",
                    rmarkdown::html_document(),
                    filename
                    )
    })
